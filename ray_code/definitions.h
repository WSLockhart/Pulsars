...
#define Nx_h 128 // # of grid points along the x-axis on the image plane [default 512]
#define Ny_h 128 // # of grid points along the y-axis on the image plane
...
#define Nt 33            // number of time grid points [default 65]

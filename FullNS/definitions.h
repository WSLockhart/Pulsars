...
#define Nx_h 512 // # of grid points along the x-axis on the image plane [default 512]
#define Ny_h 512 // # of grid points along the y-axis on the image plane
                 // the fine grid covers "frac" times the spot size
#define frac 1.2
...
#define Nt 32              // number of time grid points [default 32]

...

{
  ...
  char filename[sizeof "../destination/LC_m.ns_rn.s_fns._tho_ths_T.bb_qns.dat"];
  sprintf(filename, "../destination/LC_%1.2f_%2.1f_%3.0f_%03d_%03d_%1.2f_%1.1f.dat", \
    mns,rns,fns,(int)(theta0*(180./M_PI)),(int)(the_spot*(180./M_PI)),Tbb,qns);
  output_LC = fopen(filename, "w");
  char filename2[sizeof filename];
  sprintf(filename2, "../destination/HS_80-60-1.5_data/HS_%1.1f_%2.1f_%3.0f_%03d_%03d_%1.2f_%1.1f.dat", \
    mns,rns,fns,(int)(theta0*(180./M_PI)),(int)(the_spot*(180./M_PI)),Tbb,qns);

...
int main(void)
{
  // double th = strtod(argv[1], NULL);
  // double ph = strtod(argv[2], NULL);
  double mag_j = current_density(0.01,0.01);
  return 0;
}
